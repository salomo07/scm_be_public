...
func FindRoles(ctx *fasthttp.RequestCtx, user models.User) { //querynya menggunakan "_id"
	...
	resFindMany, err, code := services.FindMany(user.IdCompany, consts.Coll_Role, queryFindRole, sort, skip, limit)
	if err != "" {
...
func UpsertRole(ctx *fasthttp.RequestCtx, user models.User) {
